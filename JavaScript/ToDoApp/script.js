...
function getToDoListAPI(){
    fetch("http://localhost:5000/api/todos/").then(res=> res.json()).then(data => {
        console.log(data);
        todos = data;
        SetUlList();}
        );
...
fetch("http://localhost:5000/api/todos/create",{headers:{
    "Content-Type" : "application/json"
} ,method:"POST",body:{title:value}}).then(res => res.json())
